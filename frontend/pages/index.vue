...
<template>
  <section class="relative isolate overflow-hidden bg-dark text-white">
    <img :src="constructionImage" alt="Konstruksi infrastruktur" fetchpriority="high" class="absolute inset-0 -z-20 h-full w-full object-cover">
