  ...
  <section class="relative isolate overflow-hidden bg-dark text-white">
    ...
    <div class="mx-auto max-w-7xl px-6 py-28 sm:px-12 lg:py-40">
      <div class="max-w-3xl">
        ...
        <div class="mt-10 flex flex-wrap gap-4 border-t border-white/30 pt-5"><div class="rounded-lg border border-white/20 px-5 py-3 text-center"><p class="text-2xl font-bold text-white">10+</p><p class="text-xs font-semibold uppercase tracking-[0.08em] text-white/70">Tahun Pengalaman</p></div><div class="rounded-lg border border-white/20 px-5 py-3 text-center"><p class="text-2xl font-bold text-white">22+</p><p class="text-xs font-semibold uppercase tracking-[0.08em] text-white/70">Proyek Selesai</p></div><div class="rounded-lg border border-white/20 px-5 py-3 text-center"><p class="text-2xl font-bold text-white">35</p><p class="text-xs font-semibold uppercase tracking-[0.08em] text-white/70">Unit Peralatan</p></div><div class="rounded-lg border border-white/20 px-5 py-3 text-center"><p class="text-2xl font-bold text-white">12</p><p class="text-xs font-semibold uppercase tracking-[0.08em] text-white/70">Klien Mitra</p></div></div>
      </div>
    </div>
  </section>
