import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, createError, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, getRequestProtocol, getRequestHost, getQuery as getQuery$1, setHeader, getHeader, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus } from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/h3/dist/index.mjs';
import destr from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/node-mock-http/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, hasProtocol, withHttps, withoutTrailingSlash, decodePath, withLeadingSlash, withBase, withTrailingSlash, parsePath, stringifyQuery, parseQuery, encodePath, stringifyParsedURL } from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/ufo/dist/index.mjs';
import { createStorage, defineDriver, prefixStorage } from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/unstorage/drivers/fs.mjs';
import crypto from 'node:crypto';
import fsDriver from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/unstorage/drivers/fs-lite.mjs';
import lruCache from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/unstorage/drivers/lru-cache.mjs';
import { digest } from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/radix3/dist/index.mjs';
import { toValue } from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/vue/index.mjs';
import { createConsola } from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/consola/dist/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname, resolve as resolve$1 } from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/pathe/dist/index.mjs';
import { createFilter } from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/nuxtseo-shared/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/salman/remakojayaabadi/frontend/server/assets"}];
...
const _47Users_47salman_47remakojayaabadi_47frontend_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js = defineDriver(
  /**
...
storage.mount('internal:nuxt:prerender', _47Users_47salman_47remakojayaabadi_47frontend_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"/Users/salman/remakojayaabadi/frontend/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"/Users/salman/remakojayaabadi/frontend/.nuxt/cache/nitro/prerender"}));
storage.mount('data', fsDriver({"driver":"fsLite","base":"./.data/kv"}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/salman/remakojayaabadi/frontend","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/salman/remakojayaabadi/frontend/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/salman/remakojayaabadi/frontend/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/salman/remakojayaabadi/frontend/.nuxt/cache"}));
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "627046b0-03cb-4023-b455-a4fe4714512d",
...
const _8oEGzEKX_826SRlo8XIf5vvVnrhi5oVULLfeMLBB8 = defineNitroPlugin((nitroApp) => {
...
const _GCgmWJ9nAv4CzEUBG4TSny9UqPCa88Tm4Ju8IPkcVg = defineNitroPlugin(async (nitroApp) => {
...
const _TJfVzJglh3bMRBKGOvK22ubvjD5Ydh8Ccw8ysWh7L4 = defineNitroPlugin(async (nitroApp) => {
...
const plugins = [
  _8oEGzEKX_826SRlo8XIf5vvVnrhi5oVULLfeMLBB8,
_GCgmWJ9nAv4CzEUBG4TSny9UqPCa88Tm4Ju8IPkcVg,
_TJfVzJglh3bMRBKGOvK22ubvjD5Ydh8Ccw8ysWh7L4
];
...
const _tUaELS = eventHandler((event) => {
...
const _rMEXux = eventHandler(async (e) => {
...
const _pp55ES = defineEventHandler(async (e) => {
  const nitroApp = useNitroApp();
...
const _osIMoX = defineEventHandler(async (e) => {
...
const _p9UjVA = defineEventHandler(async (e) => {
...
async function parseSitemapXml(xml) {
  ...
  const { XMLParser } = await import('file:///Users/salman/remakojayaabadi/frontend/node_modules/fast-xml-parser/src/fxp.js');
...
const _1bnGV9 = defineEventHandler(sitemapXmlEventHandler);

const _SxA8c9 = defineEventHandler(() => {});

const _lazy_SehgLC = () => import('../_/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '', handler: _tUaELS, lazy: false, middleware: true, method: undefined },
  { route: '', handler: _rMEXux, lazy: false, middleware: true, method: undefined },
  { route: '/robots.txt', handler: _pp55ES, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _osIMoX, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _p9UjVA, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _1bnGV9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_SehgLC, lazy: true, middleware: false, method: undefined }
];
