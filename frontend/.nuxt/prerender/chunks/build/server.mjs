import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, getCurrentInstance, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, defineAsyncComponent, computed, unref, shallowReactive, ref, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, toRef, withCtx, nextTick, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRaw, toValue } from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/ofetch/dist/node.mjs';
import { u as useHead$1, h as headSymbol, b as baseURL, a as useSeoMeta$1 } from '../_/renderer.mjs';
import { createHooks } from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode } from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/h3/dist/index.mjs';
import { defu } from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/defu/dist/defu.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/vue-router/vue-router.node.mjs';
import { hasProtocol, withBase, parseURL, encodePath, decodePath, withQuery, isScriptProtocol, joinURL, withoutTrailingSlash, stringifyQuery, withTrailingSlash, withLeadingSlash, hasTrailingSlash } from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/ufo/dist/index.mjs';
import { TemplateParamsPlugin, InferSeoMetaPlugin, defineHeadPlugin } from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/unhead/dist/plugins.mjs';
import { titleCase } from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/scule/dist/index.mjs';
import { processTemplateParams } from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/unhead/dist/utils.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///Users/salman/remakojayaabadi/frontend/node_modules/vue/server-renderer/index.mjs';
import 'file:///Users/salman/remakojayaabadi/frontend/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import '../nitro/nitro.mjs';
import 'file:///Users/salman/remakojayaabadi/frontend/node_modules/destr/dist/index.mjs';
import 'file:///Users/salman/remakojayaabadi/frontend/node_modules/node-mock-http/dist/index.mjs';
import 'file:///Users/salman/remakojayaabadi/frontend/node_modules/unstorage/dist/index.mjs';
import 'file:///Users/salman/remakojayaabadi/frontend/node_modules/unstorage/drivers/fs.mjs';
import 'node:crypto';
import 'file:///Users/salman/remakojayaabadi/frontend/node_modules/unstorage/drivers/fs-lite.mjs';
import 'file:///Users/salman/remakojayaabadi/frontend/node_modules/unstorage/drivers/lru-cache.mjs';
import 'file:///Users/salman/remakojayaabadi/frontend/node_modules/ohash/dist/index.mjs';
import 'file:///Users/salman/remakojayaabadi/frontend/node_modules/klona/dist/index.mjs';
...
import 'file:///Users/salman/remakojayaabadi/frontend/node_modules/unhead/dist/server.mjs';
import 'node:async_hooks';
import 'file:///Users/salman/remakojayaabadi/frontend/node_modules/devalue/index.js';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-Djglx0LR.mjs')
  },
  {
    name: "layanan",
    path: "/layanan",
    component: () => import('./layanan-D3Tz9nKj.mjs')
  },
  {
    name: "proyek",
    path: "/proyek",
    component: () => import('./index-CLP2sRYO.mjs')
  },
  {
    name: "proyek-slug",
    path: "/proyek/:slug()",
    component: () => import('./_slug_-aEY4hatr.mjs')
  }
];
...
const resolverImports = {
  address: () => import('./index28-DYtHivoa.mjs'),
  aggregateOffer: () => import('./index-CwfxthY7.mjs'),
  aggregateRating: () => import('./index2-a3iXioRI.mjs'),
  article: () => import('./index3-Wj4Hd-sz.mjs').then(function(n) {
    return n.l;
  }),
  breadcrumb: () => import('./index3-Wj4Hd-sz.mjs').then(function(n) {
    return n.i;
  }),
  comment: () => import('./index5-B_cWQuKy.mjs'),
  course: () => import('./index6-C7ZQcfU-.mjs'),
  dataset: () => import('./index7-BCN6m-Qr.mjs'),
  event: () => import('./index10-CRGGlC-Q.mjs'),
  foodEstablishment: () => import('./index11-N1-N_7qm.mjs'),
  virtualLocation: () => import('./index9-CtQgFTK9.mjs'),
  place: () => import('./index8-BcKc5g_d.mjs'),
  howTo: () => import('./index13-DU43w2t7.mjs'),
  howToStep: () => import('./index12-BSuLvA3i.mjs').then(function(n) {
    return n.i;
  }),
  image: () => Promise.resolve().then(function() {
    return index;
  }),
  localBusiness: () => import('./index17-DNRR6Qkw.mjs'),
  offer: () => import('./index23-C3Pbru72.mjs'),
  openingHours: () => import('./index24-C2QZ1B09.mjs'),
  organization: () => import('./index3-Wj4Hd-sz.mjs').then(function(n) {
    return n.h;
  }),
  person: () => import('./index3-Wj4Hd-sz.mjs').then(function(n) {
    return n.k;
  }),
  product: () => import('./index29-BF-Dkc1B.mjs'),
  question: () => import('./index30-D0yXCbU0.mjs'),
  recipe: () => import('./index31-CzDt4azL.mjs'),
  review: () => import('./index32-DetP-Vdn.mjs'),
  video: () => import('./index38-CDnWnx6M.mjs'),
  webPage: () => import('./index3-Wj4Hd-sz.mjs').then(function(n) {
    return n.j;
  }),
  webSite: () => import('./index3-Wj4Hd-sz.mjs').then(function(n) {
    return n.g;
  }),
  book: () => import('./index4-D9WVdYUT.mjs'),
  itemList: () => import('./index14-BjEueEjF.mjs'),
  jobPosting: () => import('./index15-Bb3rLJnq.mjs'),
  listItem: () => import('./index16-YtZ5GqU0.mjs'),
  movie: () => import('./index18-CaLJv6iO.mjs'),
  musicAlbum: () => import('./index19-BOcicZ-e.mjs'),
  musicGroup: () => import('./index20-sm4ezyBR.mjs'),
  musicPlaylist: () => import('./index21-8me8uanG.mjs'),
  musicRecording: () => import('./index22-iiAGCQUJ.mjs'),
  podcastEpisode: () => import('./index25-YNPsd_Qx.mjs'),
  podcastSeason: () => import('./index26-aHmrn5TA.mjs'),
  podcastSeries: () => import('./index27-DExQeJ5t.mjs'),
  searchAction: () => import('./index40-DZhmvGWS.mjs'),
  readAction: () => import('./index39-CQCN2UrC.mjs'),
  service: () => import('./index33-DlLsqfQO.mjs'),
  softwareApp: () => import('./index34-DPQiw35Z.mjs'),
  tvEpisode: () => import('./index35-ve3M_7QO.mjs'),
  tvSeason: () => import('./index36-wfZSHCg2.mjs'),
  tvSeries: () => import('./index37-CdpwzvEZ.mjs'),
  bookEdition: () => import('./index4-D9WVdYUT.mjs')
};
        ...
        "tags:resolve": async (ctx) => {
          for (const k in ctx.tags) {
            ...
            if (tag.tag === "script" && tag.props.type === "application/ld+json" && tag.props.nodes) {
              ...
              const minify = options?.minify || "prerender" === "production";
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CRIwFt1t.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BesjnnlE.mjs'));
...
export { IdentityId as I, _export_sfc as _, useRoute as a, resolvableDateToIso as b, createError as c, defineSchemaOrgResolver as d, entry_default as default, resolveDefaultType as e, resolvableDateToDate as f, resolveNode as g, asArray as h, idReference as i, dedupeMerge as j, resolveWithBase as k, imageResolver as l, useRouter as m, encodeRoutePath as n, resolveRouteObject as o, navigateTo as p, useNuxtApp as q, resolveRelation as r, setIfEmpty as s, useRuntimeConfig as t, useHead as u, nuxtLinkDefaults as v, resolveAsGraphKey as w, prefixId as x, trimLength as y };
