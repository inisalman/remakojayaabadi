...
import { sanitizeStatusCode, createError as createError$1, appendHeader } from "/Users/salman/remakojayaabadi/frontend/node_modules/h3/dist/index.mjs";
...
import { hasProtocol, joinURL, withQuery, parseURL, encodePath, decodePath, isScriptProtocol } from "/Users/salman/remakojayaabadi/frontend/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-D4Jww-gy.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-9dvK-0RA.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BGeuQzOk.js"));
